                                        ...
                                        <div className="p-6 bg-slate-50 border border-slate-100 rounded-2xl">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex items-center justify-between text-[11px] font-bold uppercase tracking-wide pb-2 border-b border-white hover:border-violet-100 transition-colors">
                                                    ...
                                                    <span className="text-violet-600">DS-{currentSelectedItem.id.toString().replace('.', '').slice(-4)}</span>
                                                </div>
                        ...
                        {currentSelectedItem && currentSelectedItem.status === 'completed' && currentSelectedItem.result && !currentSelectedItem.result.is_valid && (
                            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }}>
                                <Card className="p-6 border-2 border-dashed border-slate-200 bg-slate-50/10 flex flex-col items-center text-center gap-4 mt-4 rounded-3xl">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-black text-slate-950 uppercase tracking-tighter mb-1">Normal Skin or Unrecognized Signature</h3>
                                        <p className="text-xs text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
                                            The engine detected healthy skin or could not confidently identify a recognizable skin condition from this image.
                                        </p>
                                    </div>
